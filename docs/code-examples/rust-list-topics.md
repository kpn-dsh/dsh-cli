...
generating rust list-topics example for bundle 'my-proxy' for 'np-aws-lz-dsh@greenbox-dev'
...
stream of messages. In the example below we use

```shell
> target/debug/my-proxy-consumer scratch.reference-implementation-protobuf.greenbox-dev
