...
and that it is tagged with the version number (currently `0.9.0`) of the release, without
...
> cargo build --release --all-features
...
> mv target/release/dsh-manage dsh-manage-v0.9.0-aarch64-apple-darwin
```
...
total 87072
...
-rwxr-xr-x   1 wilbert  staff  23506384  6 mrt. 09:51 dsh-manage-v0.9.0-aarch64-apple-darwin
-rwxr-xr-x   1 wilbert  staff  21444176  6 mrt. 09:51 dsh-v0.9.0-aarch64-apple-darwin
...
```
...
* All macOS binaries are available, properly named, codesigned and notarized:
    * `dsh-manage-v0.9.0-aarch64-apple-darwin`
    * `dsh-v0.9.0-aarch64-apple-darwin`
...
* Select `0.9.0` from the `Select tag` dropdown menu.
* Enter `0.9.0` for the release title.
