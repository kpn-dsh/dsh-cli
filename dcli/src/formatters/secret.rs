...
pub static SECRET_USAGE_IN_APPS_LABELS_LIST: [SecretUsageLabel; 3] = [SecretUsageLabel::Target, SecretUsageLabel::App, SecretUsageLabel::Injections];
pub static SECRET_USAGE_IN_APPLICATIONS_LABELS_LIST: [SecretUsageLabel; 3] = [SecretUsageLabel::Target, SecretUsageLabel::Application, SecretUsageLabel::Injections];
