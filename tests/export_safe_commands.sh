...
export SAFE_COMMANDS=(
  ...
  "platform export"
  "platform list"
  "platform open app $APP_UNDER_TEST --platform $PLATFORM_UNDER_TEST --tenant $TENANT_UNDER_TEST"
  "platform open app $APP_UNDER_TEST"
  "platform open console --platform $PLATFORM_UNDER_TEST --tenant $TENANT_UNDER_TEST"
  "platform open console"
  "platform open monitoring --platform $PLATFORM_UNDER_TEST --tenant $TENANT_UNDER_TEST"
  "platform open monitoring"
  "platform open service $APPLICATION_UNDER_TEST --platform $PLATFORM_UNDER_TEST --tenant $TENANT_UNDER_TEST"
  "platform open service $APPLICATION_UNDER_TEST"
  "platform open swagger --platform $PLATFORM_UNDER_TEST"
  "platform open swagger"
  "platform open tenant --platform $PLATFORM_UNDER_TEST --tenant $TENANT_UNDER_TEST"
  "platform open tenant"
  "platform open tracing --platform $PLATFORM_UNDER_TEST"
