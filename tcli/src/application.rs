...
use trifonius_dsh_api::application::application_diff;
...
use crate::{to_command_error_with_id, TcliContext, TcliResult};
...
fn print_applications(applications: &HashMap<String, Application>, context: &TcliContext) -> TcliResult {
