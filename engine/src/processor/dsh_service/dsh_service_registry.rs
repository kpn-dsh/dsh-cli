...
impl<'a> DshServiceRealizationRegistry<'a> {
  pub(crate) fn create<'b: 'a>(target_client_factory: &'b TargetClientFactory, resource_registry: &'a ResourceRegistry) -> Result<DshServiceRealizationRegistry<'a>, String> {
